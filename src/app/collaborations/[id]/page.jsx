      ...
      <div className="bg-gray-50 py-12 px-6">
        <div className="container mx-auto text-left">
          <img
            ...
            className="mb-6 w-64"
          />
          <p className="text-lg leading-relaxed">{logos[id].content}</p>
          <button
        ...
        <div className="container mx-auto text-left">
          ...
          <div className="mb-8 space-y-4 p-6 rounded-lg shadow">
            <p className="text-lg font-semibold text-gray-800">
              ...
              Established in 1980, Jainsons India has a proven track record in
              the electrical and networking industry.
            </p>
            <p className="text-lg font-semibold text-gray-800">
              <span className="text-[#880909] ">
                Strong Global Partnerships:
              </span>{" "}
              We work with top international brands to provide high-quality
              products and solutions.
            </p>
            <p className="text-lg font-semibold text-gray-800">
              <span className="text-[#880909] ">Extensive Product Range:</span>{" "}
              From industrial automation to power distribution, we offer a
              diverse range of components and tools.
            </p>
            <p className="text-lg font-semibold text-gray-800">
              <span className="text-[#880909] ">
                Reliable Distribution Network:
              </span>{" "}
              With a well-established supply chain, we ensure timely delivery
              across India.
            </p>
          </div>
